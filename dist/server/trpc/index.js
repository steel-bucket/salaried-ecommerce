...
var paymentrouter_1 = require("./routers/paymentrouter");
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        var query, cursor, sort, limit, q, payload, parsedQuery, page, _c, items, hasNextPage, nextPage;
        var input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    query = input.query, cursor = input.cursor;
                    sort = query.sort, limit = query.limit, q = __rest(query, ["sort", "limit"]);
