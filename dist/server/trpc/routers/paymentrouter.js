...
exports.paymentrouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        var user, productIds, payload, result, products, filteredProducts, order, orders, line_items, stripeSession, err_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    result = _c.sent();
                    products = result.docs.map(function (doc) { return ({
                        id: doc.id,
                        name: doc.name,
                        price: doc.price,
                ...
                case 5:
                    ...
                    return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                            success_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/orderplaced?orderId=").concat(order.id),
