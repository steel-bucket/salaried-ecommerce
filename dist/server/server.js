        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    payload.logger.info("hahaha server is running on http://localhost:".concat(PORT));
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("Next JS server URL ".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                            return [2 /*return*/];
                        });
                    }); });
                });
