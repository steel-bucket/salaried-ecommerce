...
var getpayload_1 = require("../server/getpayload");
var resend_1 = require("resend");
var ReceiptEmail_1 = require("../components/Emails/ReceiptEmail");
var resend = new resend_1.Resend(process.env.RESENDAPIKEY);
var stripeWebhookHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                _c.sent();
                if (!(!user.email || typeof user.email !== 'string')) return [3 /*break*/, 5];
                res.status(500).json();
                return [3 /*break*/, 8];
            case 5:
                _c.trys.push([5, 7, , 8]);
