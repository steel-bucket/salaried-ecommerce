...
function constructMetadata(_a) {
    ...
    return __assign({ title: title, description: description, openGraph: {
        ...
        }, icons: icons, metadataBase: new URL('https://yettobeupdated.com') }, (noIndex && {
        robots: {
            index: false,
            follow: false,
        },
